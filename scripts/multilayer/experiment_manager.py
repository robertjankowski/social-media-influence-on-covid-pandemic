...
if __name__ == '__main__':
    ...
    run_parallel(qs, ps, 'p_5_q', experiment1, l1_params=PhysicalLayerParameters(0.7, 0.5, 0.85, 0.1, 10),
                 n_runs=1, cpus=10, n_agents=10000, n_steps=200000, negative_opinion_fraction=0.0)
